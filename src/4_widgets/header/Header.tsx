...
export default function HeaderContent(): JSX.Element {
  return (
    <header className={`${classes.header} text-2xl text-white bg-[#1356a5] pr-[2vw] pl-[2vw] fixed w-[100vw]`}>
        <div className='text-center'><Icon className={`bg-[#1356a5] h-[12vh] ${classes.logo}`}  href='https://www.sechenov.ru/' src="/images/Logo_sechenov.jpg"/></div>
        <MyHideBlock className={`text-center flex justify-between`} id='nav-header' dataFoldingSize='lg'>
            <span>Главная</span>
        ...
        <div className='flex justify-center items-center '>
            ...
            <MyHideBlock.BurgerButton className={`w-[30px] h-[30px]`} id='nav-header' dataFoldingSize='lg'>
                <FaBars size={30} />
